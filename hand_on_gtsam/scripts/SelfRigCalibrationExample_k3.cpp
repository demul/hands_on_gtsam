...
{
    vector<Cal3DS2_k3> intrinsics;
    intrinsics.emplace_back(45.0, 45.0, 0.0, 45.0, 45.0, 0.0001, 0.0001, 0.0001, 0.0001, 0.0001);
    intrinsics.emplace_back(40.0, 40.0, 0.0, 40.0, 40.0, 0.0001, 0.0001, 0.0001, 0.0001, 0.0001);
    intrinsics.emplace_back(55.0, 55.0, 0.0, 55.0, 55., 0.0001, 0.0001, 0.0001, 0.0001, 0.0001);
    ...
    vector<PinholeCamera<Cal3DS2_k3>> rig_set;
    ...
    {
        PinholeCamera<Cal3DS2_k3>& rig = rig_set[camera_index];
        for (size_t pose_index = 0; pose_index < poses.size(); pose_index++)
        {
            PinholeCamera<Cal3DS2_k3> camera(poses[pose_index].compose(rig.pose()), rig.calibration());
            for (size_t point_index = 0; point_index < points.size(); point_index++)
            {
                ...
                graph.emplace_shared<ProjectionFactorPPPC<Pose3, Point3, Cal3DS2_k3>>(
                    measurement,
                    measurementNoise,
                    Symbol('x', pose_index),
    ...
    for (size_t camera_index = 0; camera_index < rig_set.size(); camera_index++)
    {
        initialEstimate.insert(
            Symbol('K', camera_index), Cal3DS2_k3(45.0, 45.0, 0.0, 45.0, 45.0, 0.0001, 0.0001, 0.0001, 0.0001, 0.0001));
        initialEstimate.insert(
            Symbol('r', camera_index),
